    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card className="bg-card/80 backdrop-blur-lg border border-primary/30 shadow-xl">
        <CardHeader>
          ...
          <CardDescription>Los usuarios creados podrán acceder al torneo sin confirmación de email</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button onClick={handleCreateUser} disabled={loading} className="w-full sport-gradient">
      ...
      <Card className="bg-card/80 backdrop-blur-lg border border-primary/30 shadow-xl">
        <CardHeader>
          <CardTitle>Usuarios del Torneo</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="space-y-2 max-h-[400px] overflow-y-auto">
            {users.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">No hay usuarios creados aún</div>
            ) : (
              users.map((user) => (
                <div
                  key={user.id}
